...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    textView = (TextView)findViewById(R.id.forecast_empty);
          ...
          new MaterialDialog.Builder(mContext).title(R.string.symbol_search)
              ...
              .input(R.string.input_hint, R.string.input_prefill, new MaterialDialog.InputCallback() {
                @Override public void onInput(MaterialDialog dialog, CharSequence input) {
                  ...
                  if (c.getCount() != 0) {
                    String msg=getString(R.string.stock_saved);
                    Toast toast =
                        Toast.makeText(MyStocksActivity.this, msg,Toast.LENGTH_LONG);
    ...
    if (isConnected){
      ...
      if(c.getCount()==0)
      {
        TextView textView = (TextView)findViewById(R.id.forecast_empty);
        if(null!=textView)
        {
          int message = R.string.empty_display;
          if(!isConnected)
          {
  ...
  /*public void showWhenNoConnection()
  {
